...
import 'package:flutter_form_validators/utils/messages.dart';
import 'package:flutter_form_validators/utils/validators.dart';
...
class FormValidators {
  ...
  static FormFieldValidator<T> required<T>({
    ...
    return (T? valueCandidate) {
      if (valueCandidate == null ||
        ...
        return errorText ?? FormValidatorErrorMessage.requiredErrorText;
      }
      return null;
    };
  }
  ...
  static FormFieldValidator<T> equal<T>(
    ...
    String? errorText,
      ...
      (valueCandidate) => valueCandidate != value
          ? errorText ?? FormValidatorErrorMessage.equalErrorText(value)
          : null;
  ...
  static FormFieldValidator<T> notEqual<T>(
    ...
    String? errorText,
      ...
      (valueCandidate) => valueCandidate == value
          ? errorText ?? FormValidatorErrorMessage.notEqualErrorText(value)
          : null;
    ...
    return (T? valueCandidate) {
      if (valueCandidate != null) {
        ...
        if (number != null && (inclusive ? number < min : number <= min)) {
          return errorText ?? FormValidatorErrorMessage.minErrorText(min);
        }
      }
      return null;
    };
    ...
    return (T? valueCandidate) {
      if (valueCandidate != null) {
        ...
        if (number != null && (inclusive ? number > max : number >= max)) {
          return errorText ?? FormValidatorErrorMessage.maxErrorText(max);
        }
      }
      return null;
    };
  ...
  static FormFieldValidator<T> minLength<T>(
    ...
    return (T? valueCandidate) {
      ...
      return valueLength < minLength && (!allowEmpty || valueLength > 0)
          ? errorText ?? FormValidatorErrorMessage.minLengthErrorText(minLength)
          : null;
    };
  }
  ...
  static FormFieldValidator<T> maxLength<T>(
    ...
    return (T? valueCandidate) {
      ...
      return null != valueCandidate && valueLength > maxLength
          ? errorText ?? FormValidatorErrorMessage.maxLengthErrorText(maxLength)
          : null;
    };
  }
  ...
  static FormFieldValidator<T> equalLength<T>(
    ...
    return (T? valueCandidate) {
      ...
      return valueLength != length && (!allowEmpty || valueLength > 0)
          ? errorText ?? FormValidatorErrorMessage.equalLengthErrorText(length)
          : null;
    };
  }
  ...
  static FormFieldValidator<String> minWordsCount(
    ...
    return (valueCandidate) {
      ...
      return valueWordsCount < minCount && (!allowEmpty || valueWordsCount > 0)
          ? errorText ??
              FormValidatorErrorMessage.minWordsCountErrorText(minCount)
          : null;
    };
  }
  ...
  static FormFieldValidator<String> maxWordsCount(
    ...
    return (valueCandidate) {
      ...
      return null != valueCandidate && valueWordsCount > maxCount
          ? errorText ??
              FormValidatorErrorMessage.maxWordsCountErrorText(maxCount)
          : null;
    };
  }
    ...
    String? errorText,
      ...
      (valueCandidate) =>
          (valueCandidate?.isNotEmpty ?? false) && !isEmail(valueCandidate!)
              ? errorText ?? FormValidatorErrorMessage.emailErrorText
              : null;
  ...
  static FormFieldValidator<String> url({
    ...
    List<String> hostBlacklist = const [],
      ...
      (valueCandidate) => true == valueCandidate?.isNotEmpty &&
          ...
          ? errorText ?? FormValidatorErrorMessage.urlErrorText
          : null;
  ...
  static FormFieldValidator<String> match(
    ...
    String? errorText,
      ...
      (valueCandidate) => true == valueCandidate?.isNotEmpty &&
          ...
          ? errorText ?? FormValidatorErrorMessage.matchErrorText
          : null;
  ...
  static FormFieldValidator<String> numeric({
    String? errorText,
      ...
      (valueCandidate) => true == valueCandidate?.isNotEmpty &&
          ...
          ? errorText ?? FormValidatorErrorMessage.numericErrorText
          : null;
  ...
  static FormFieldValidator<String> integer({
    ...
    int? radix,
      ...
      (valueCandidate) => true == valueCandidate?.isNotEmpty &&
          ...
          ? errorText ?? FormValidatorErrorMessage.integerErrorText
          : null;
    ...
    String? errorText,
      ...
      (valueCandidate) =>
          true == valueCandidate?.isNotEmpty && !isCreditCard(valueCandidate!)
              ? errorText ?? FormValidatorErrorMessage.creditCardErrorText
              : null;
    ...
    String? errorText,
      ...
      (valueCandidate) =>
          true == valueCandidate?.isNotEmpty && !isIP(valueCandidate!, version)
              ? errorText ?? FormValidatorErrorMessage.ipErrorText
              : null;
    ...
    String? errorText,
      ...
      (valueCandidate) =>
          true == valueCandidate?.isNotEmpty && !isDate(valueCandidate!)
              ? errorText ?? FormValidatorErrorMessage.dateStringErrorText
              : null;
}
